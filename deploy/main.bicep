...
param storeImage string = 'ghcr.io/azure/container-apps-store-api-microservice/store-service:latest'
param storePort int = 3000
param isStoreExternalIngress bool = true

// order service
param orderMinReplicas int = 1
param orderImage string = 'ghcr.io/azure/container-apps-store-api-microservice/order-service:latest'
param orderPort int = 5000
param isOrderExternalIngress bool = false

// inventory service
param inventoryMinReplicas int = 1
param inventoryImage string = 'ghcr.io/azure/container-apps-store-api-microservice/inventory-service:latest'
